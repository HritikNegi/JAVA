...
class ABCDEF {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "/Users/HRITIKNEGI/JavaLearning/src/Unit_03/Input.txt";
...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("/Users/HRITIKNEGI/JavaLearning/src/Unit_03/output.txt");
		} catch (IOException e) {
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("/Users/HRITIKNEGI/JavaLearning/src/Unit_03/log.txt", true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
